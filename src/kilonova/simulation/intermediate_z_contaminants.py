...
# radius, luminosity for each of 120 draws), not a sampled spectrum: the Planck function is built
# from it on demand, which turns hundreds of megabytes of SED cube into 113 kB. Regenerated by
